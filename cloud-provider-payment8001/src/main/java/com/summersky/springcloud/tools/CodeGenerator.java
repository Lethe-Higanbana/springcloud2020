package com.summersky.springcloud.tools;
...
public class CodeGenerator {
     ...
     * 初始化文件路径
     */
    private static String packageName = "src/main/java";
    /**
     * 代码生成路径
     */
    private static String customPath = "com.summersky.springcloud";
    /**
     * 作者
     */
    private static String authorName = "zengfanbin";
    /**
     * 表名
     */
     ...
     * 表前缀
     */
    private static String tableFix = "";
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator autoGenerator=new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("root")
                        .setUrl("jdbc:mysql://localhost:3306/db2019?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false")
        ).setStrategy(
                //策略配置
                new StrategyConfig()
                        // .setCapitalMode(true)// 全局大写命名
                        //.setDbColumnUnderline(true)//全局下划线命名
                        .setTablePrefix(new String[]{tableFix})// 此处可以修改为您的表前缀
